...
for i in train_dir_list:
    ...
    for f in file_list:
        ...
        if  i== "Adam":
            ...
            if int(adam_dit[f.split('.')[0]])>=3:
                emotion=1
            else:
                emotion=0
        elif  i== "Apryl":
            #emotion =  apryl_dit[f.split('.')[0]]
            if int(apryl_dit[f.split('.')[0]])>=3:
                emotion=1
            else:
                emotion=0
        elif  i== "Lisa":
            #emotion =  lisa_dit[f.split('.')[0]]
            if int(lisa_dit[f.split('.')[0]])>=3:
                emotion=1
            else:
                emotion=0
        elif  i== "Spencer":
            #emotion =  spencer_dit[f.split('.')[0]]
            if int(spencer_dit[f.split('.')[0]])>=3:
                emotion=1
            else:
                emotion=0
...
with open("model/mymodeltest.json", "w") as json_file:
    json_file.write(model_json) 
    

json_file = open('model/mymodeltest.json', 'r')
